...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"turn",prev:"",next:"",duration:13*100,delay:70*100,width:1200,height:450,autoPlay:true,autoPlayVideo:false,playPause:true,stopOnHover:false,loop:false,bullets:1,caption:true,captionEffect:"parallax",controls:true,controlsThumb:["data1/tooltips/1.jpg", "data1/tooltips/2.jpg"],responsive:1,fullScreen:false,gestures:2,onBeforeStep:0,images:0});